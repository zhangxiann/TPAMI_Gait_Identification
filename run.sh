...
nohup python -u train_gait_cnn.py --img_type counts_only_two_channel --epoch 60 --cuda 0 > counts_only_two_channel.log 2>&1 &
nohup python -u train_gait_cnn.py --img_type counts_and_time_two_channel --epoch 60 --cuda 1 > counts_and_time_two_channel.log 2>&1 &
