...
class ResidualBlock(torch.nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.left_conv1 = GMMConv(in_channel, out_channel, dim=3, kernel_size=4)
        self.left_bn1 = torch.nn.BatchNorm1d(out_channel)
        self.left_conv2 = GMMConv(out_channel, out_channel, dim=3, kernel_size=4)
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GMMConv(1, 64, dim=3, kernel_size=4)
